...
const DashboardHeader = ({ user, projectId, id, subtitle }) => {
  return (
    <div>
      <div className="max-w-5xl mx-auto px-6">
        <div className="absolute pt-2 z-0">
          ...
          {id && (
          <Link href={`/[license]/[projectId]/members`} as={`/${user.license}/${projectId}/members`}>
            <a className="ml-3 inline-block text-xs text-indigo-500 uppercase tracking-wide hover:text-indigo-700">
              ...
              <span className="block float-left leading-none">Members</span>
            </a>
          </Link>
          )}
        </div>
