...
const DashboardHeader = ({ module, user, projectId, subtitle }) => {
  return (
    <div>
      <div className="max-w-5xl mx-auto px-6">
        <div className="absolute pt-2 z-0">
          ...
          {module && (
          <Link href={`/[license]/[projectId]/modules`} as={`/${user.license}/${projectId}/modules`}>
            <a className="ml-3 inline-block text-xs text-indigo-500 uppercase tracking-wide hover:text-indigo-700">
              ...
              <span className="block float-left leading-none">Modules</span>
            </a>
          </Link>
          )}
        </div>
